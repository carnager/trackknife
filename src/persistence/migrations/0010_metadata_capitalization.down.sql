...
CREATE TEMP TABLE metadata_capitalization_downgrade_guard (
    value INTEGER NOT NULL CHECK(value = 0)
);
INSERT INTO metadata_capitalization_downgrade_guard
    SELECT COUNT(*) FROM metadata_transformation_actions WHERE kind = 10;
DROP TABLE metadata_capitalization_downgrade_guard;

ALTER TABLE metadata_transformation_action_values
    RENAME TO metadata_transformation_action_values_v10;
ALTER TABLE metadata_transformation_actions
    RENAME TO metadata_transformation_actions_v10;
...
INSERT INTO metadata_transformation_actions
    SELECT * FROM metadata_transformation_actions_v10;
INSERT INTO metadata_transformation_action_values
    SELECT * FROM metadata_transformation_action_values_v10;

DROP TABLE metadata_transformation_action_values_v10;
DROP TABLE metadata_transformation_actions_v10;
