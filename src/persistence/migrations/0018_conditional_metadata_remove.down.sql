...
CREATE TEMP TABLE metadata_conditional_remove_downgrade_guard (
    value INTEGER NOT NULL CHECK(value = 0)
);
INSERT INTO metadata_conditional_remove_downgrade_guard
    SELECT COUNT(*) FROM metadata_transformation_actions WHERE kind = 15;
DROP TABLE metadata_conditional_remove_downgrade_guard;

ALTER TABLE metadata_transformation_action_values
    RENAME TO metadata_transformation_action_values_v18;
ALTER TABLE metadata_transformation_actions
    RENAME TO metadata_transformation_actions_v18;
...
INSERT INTO metadata_transformation_actions
    SELECT * FROM metadata_transformation_actions_v18;
INSERT INTO metadata_transformation_action_values
    SELECT * FROM metadata_transformation_action_values_v18;

DROP TABLE metadata_transformation_action_values_v18;
DROP TABLE metadata_transformation_actions_v18;
