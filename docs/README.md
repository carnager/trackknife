...
M5 is closing into M6, implementation is accepted through ADR-0105, and the persistence
...
and [`adr/0105-qualified-audio-conversion-core.md`](adr/0105-qualified-audio-conversion-core.md).
