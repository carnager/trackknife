...
M5 is closing into M6, implementation is accepted through ADR-0108, and the persistence
...
and [`adr/0108-saved-encoder-presets.md`](adr/0108-saved-encoder-presets.md).
