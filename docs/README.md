...
M5 is closing into M6, implementation is accepted through ADR-0097, and the persistence
...
for sub-gate material. Native WavPack is now the second
...
and [`adr/0097-validated-loudness-analysis-core.md`](adr/0097-validated-loudness-analysis-core.md).
