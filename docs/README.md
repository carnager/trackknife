...
M5 is closing into M6, implementation is accepted through ADR-0104, and the persistence
...
and [`adr/0104-grouped-numbering-transformation.md`](adr/0104-grouped-numbering-transformation.md).
